...
public class AppointmentsSteps extends BaseUI {
    ...
    public void filling_out_the_form() throws InterruptedException {
        ...
        appointmentsPage.getPatientByName("Anderson", "Raj").click();
       ...
       // appointmentsPage.scheduleButton.click();
        //Thread.sleep(2000);

    }

    @When("clicks on the schedule button")
    public void clicks_on_the_schedule_button() throws InterruptedException {
        //Thread.sleep(2000);
    ...
    public void doctor_should_see_appointment_scheduled() throws InterruptedException {
        ...
        //waitUntilVisible(20, appointmentsPage.appointmentScheduledSuccessfullyMessage);
